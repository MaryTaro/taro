        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
          <div class="flex flex-col text-center w-full mb-20">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">
              Ка́рты таро́ — колода карт, используемая с середины XIV века в
              различных частях Европы для карточных игр (итальянский tarocchi,
              французский tarot и австрийский Königrufen), во многие из которых
              играют и сегодня. С конца XVIII века карты таро стали
              использоваться и для предсказания.
            </p>
          </div>
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              ...
              <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p class="leading-relaxed text-lg mb-4">
                  ...
                  <li>
                    Сеансы помогают расслабиться и выйти из состояния стресса.
                    Вернуть радость жизни и убрать страхи и неуверенность в
                    себе.
                  </li>
                  <li>
                    Добавляет энергии в моменты когда нет желания общаться с
                    людьми, выходить из дома, работать. Когда есть ощущение
                    хронической усталости даже если вы ничего не делаете.
                  </li>
                  <li>
                    Гармонизирует отношения с близкими, если они стали
                    напряженными.
                  </li>
